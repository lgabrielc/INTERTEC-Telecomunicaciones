        ...
        <div class="modal-body">
            <form action={{ route('servidor.store') }} method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nombreServidor" value="{{$servidor->nombreServidor}}" name="nombreServidor" required>
                </div>
                <div class="form-group">
                  <label for="message-text" class="col-form-label">Ip de Entrada:</label>
                  <input type="text" class="form-control" id="ipEntrada"   name="ipEntrada" required>
                </div>
                <div class="form-group">
                  <label for="message-text" class="col-form-label">Ip de Salida:</label>
                  <input type="text"class="form-control" id="ipSalida" name="ipSalida" required>
                </div>
        </div>
