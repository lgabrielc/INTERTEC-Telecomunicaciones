<div>
        ...
        <div class="w-full">
            <div class="bg-white  rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500 w-full">
                <div class="container w-full">
                    <div class=w-full">
                        <h1 class="text-2xl font-semibold leading-tight mb-2">Gestionar Antena</h1>
                        @include('livewire.admin.antena.modalcrear')
                                    ...
                                    <table class="min-w-full leading-normal">
                                        <thead>
                                            <tr>
                                                ...
                                                <th wire:click="order('nombre')"
                                                    ...
                                                    <i class="px-4 fas fa-sort float-right mt-1">Nombre</i>
                                                </th>
                                        ...
                                        <tbody>
                                            @foreach ($antenas as $antena)
                                                <tr>
                                                    <td
                                                        class="py-4 border-b border-gray-200 bg-white text-sm text-center">
                                                    ...
                                                    <td
                                                        class="py-1 border-b border-gray-200 bg-white text-sm text-center">
                                                        <p class="text-gray-900 whitespace-no-wrap">
                                                            {{ $antena->servidor->nombre }}
                                                        </p>
                                                    </td>
                                                    <td
                                                        class="py-1 border-b border-gray-200 bg-white text-sm text-center">
                                                        <p class="text-gray-900 whitespace-no-wrap">
                                                            {{ $antena->tipoantena->nombre }}
                                                        </p>
                                                    </td>
                                                    <td
                                                        class="py-1 border-b border-gray-200 bg-white text-sm text-center">

                                                        <button wire:click="edit({{ $antena->id }})" type="button"
                                                            class="btn btn-info rounded-pill mx-1 my-1"
                                                            data-toggle="modal" data-target="#updateModal">
                                                            Editar
                                                        </button>
                                                        <button wire:click="$emit('deletthis', {{ $antena->id }})"
    ...
    @include('livewire.admin.antena.modaleditar')
    <script>
